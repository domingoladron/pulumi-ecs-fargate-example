...
namespace MyApi.Service
{
    ...
    public static class LoggingExtensions
    {
        ...
        /// </summary>
        /// <param name="logger"></param>
        /// <param name="model">Model object to log</param>
        public static void LogModelToJson(this ILogger logger, dynamic model = null)
        {
            if (model != null)
            {
                var message = (string)JsonConvert.SerializeObject(model);
